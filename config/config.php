...
# Default DB name for this app
	define('DB_NAME', 'devinsha_p2_devinshackle_com'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'FSSe78xBGmVxF8DCYCAN2LGnLxABorzRrAMigFt6');
	define('TOKEN_SALT', 'mqLDHs2xaF8In8gZITCL8j006grVa4nZZBfs65yw');